    ...
    <div class="mx-1 my-1 bg-white rounded-lg overflow-hidden shadow-sm">
      <div class="p-6 space-y-4">
        ...
        <div>
          ...
          <input v-model="confirmPassword" type="password" class="w-full p-2 border border-gray-200 rounded-md" />
      ...
      <div class="px-6 pb-6 flex justify-center">
        <button @click="saveHospitalInfo" class="w-32 py-2 rounded-full text-sm transition enabled:bg-blue-500 enabled:hover:bg-blue-600 enabled:text-white disabled:bg-blue-200 disabled:text-white" :disabled="!isFormValid">
          CONFIRM
        </button>
      </div>
    </div>
