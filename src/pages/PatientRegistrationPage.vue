...
<template>
    <div class="flex flex-col items-center min-h-screen bg-gray-50 w-full">
        ...
        <div class="w-[90%] max-w-[1400px] bg-white p-8 shadow-lg rounded-lg flex flex-col items-center">
            <TermsAgreement v-if="!showForm" v-model:agreed="agreed" />
            <button @click="handleNext" v-if="!showForm"
                class="w-32 py-3 bg-blue-500 text-white font-semibold rounded-full">NEXT</button>
